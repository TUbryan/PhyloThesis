...
Data = np.load(r'C:\Users\bryan\Desktop\master thesis\FeatureMatrix.npy', allow_pickle = True) 
...
def FinalData(Data):
    ...
    for i in range(0,len(Data)):
        tracker = MAFGenerator(Data[i][0][0],Data[i][0][1],10,list(Data[i][1]))
